...
!function (s) {
  "use strict";
  s.on("body", "submit", ".js-kickyooaddonsform-form", function (e) {
    e.preventDefault();
    var a = e.target, n = s.$(".message", a), v = true;

    function r(e, t) {
      if (typeof e === 'object' && e.statusText) {
        s.removeClass(n, "uk-hidden uk-text-danger"), s.addClass(n, "uk-text-" + (t ? "danger" : "success")), n.innerText = e.statusText;
