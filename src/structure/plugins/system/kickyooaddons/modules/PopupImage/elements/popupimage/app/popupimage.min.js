window.popupimage = {
  ...
  showPopup: function() {
    ...
    var modal = UIkit.util.$("#" + this.modalid);

    modal.classList.remove('uk-hidden');
    UIkit.util.$('.kick-popupimage-close', modal).addEventListener('click', function(e) {
      modal.remove();
    });
  },
  ...
  loadEvents: function() {
    ...
    this.addEvent(document, "mouseout", function(e) {
      ...
      // Reliable, works on mouse popupimageing window and
  ...
  init: function(opts) {
    ...
    this.domReady(function() {
      ...
      // Handle the cookie
      if(popupimage.checkCookie())
        return;

      // Load events
      setTimeout(function() {
        popupimage.loadEvents();

        if(popupimage.showOnDelay)
          popupimage.showPopup();
      }, popupimage.delay * 1000);
    });
  }
}
