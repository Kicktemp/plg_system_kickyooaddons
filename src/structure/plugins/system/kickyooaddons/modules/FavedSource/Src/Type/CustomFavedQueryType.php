...
namespace Kicktemp\YOOaddons\FavedSource\Src\Type;

use Kicktemp\YOOaddons\FavedSource\Src\ArticleHelper;
use function YOOtheme\trans;

class CustomFavedQueryType
{
    /**
     * @return array
     */
        ...
        return [
            'fields' => [
                'customFaved' => [
                    ...
                    'metadata' => [
                        'label' => trans('Custom Faved Articles'),
                        'group' => trans('Kicktemp'),
                        'fields' => [
                            'group' => [
                                'label' => trans('Filter by Bookmark Group'),
                                'description' => trans(
