...
!function (s) {
  "use strict";
  s.on("body", "submit", ".js-form-form", function (e) {
    e.preventDefault();
    var a = e.target, n = s.$(".message", a), v = true;

    function r(e, t) {
      s.removeClass(n, "uk-hidden uk-text-danger"), s.addClass(n, "uk-text-" + (t ? "danger" : "success")), n.innerText = e;
    ...
    s.addClass(n, "uk-hidden"), fetch(s.attr(a, "action"), {method: "post", body: new FormData(a)}).then(re => {
      re.json().then(t => {
        if (re.ok) {
          const {message: m, redirect: s, notification: n} = t;
    ...
    /*s.addClass(n, "uk-hidden"), s.ajax(s.attr(a, "action"), {
      data: new FormData(a),
      method: "POST",
      responseType: "json"
    }).then(function (e) {
      var t = e.response, m = t.message, s = t.redirect, n = t.notification;
      n ? ( UIkit.notification({
        message: n.message,
        timeout: n.timeout,
        status: n.status,
      ...
      var t = e.xhr, n = t.response, s = t.statusText;
      return r(n || s, !0)
    })*/
  })
}(UIkit.util);
