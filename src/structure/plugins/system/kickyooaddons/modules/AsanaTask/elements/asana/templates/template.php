...
<?= $el($props, $attrs) ?>
    ...
    <form class="uk-form uk-panel js-form-brevo" method="post"<?= $this->attrs($form) ?><?= ($props['novalidate']) ? ' novalidate' : '' ?>>
        ...
        <?= $grid($props) ?>
            ...
            <?php if ($props['show_name']) : ?>
                ...
                <?php if ($props['show_first_name']) : ?>
                    <div class="uk-form-controls uk-inline uk-display-block"><?= $input($props, ['name' => 'first_name', 'placeholder' => ['{label_first_name}'], 'data-message' => $props['required']->firstname, 'required' => true]) ?></div>
                <?php endif ?>
                <?php if ($props['show_last_name']) : ?>
                    <div class="uk-form-controls uk-inline uk-display-block"><?= $input($props, ['name' => 'last_name', 'placeholder' => ['{label_last_name}'], 'data-message' => $props['required']->lastname,'required' => true]) ?></div>
                <?php endif ?>
